...
public struct ChartForm {
    ...
    public static let extraLarge = CGSize(width: UIScreen.screenWidth * 0.7, height: UIScreen.screenHeight * 0.35)
    public static let detail = CGSize(width:180, height:160)
    #else
    public static let small = CGSize(width:180, height:120)
    public static let medium = CGSize(width:180, height:240)
    //public static let medium = CGSize(width: UIScreen.screenWidth * 0.7, height: UIScreen.screenHeight * 0.27)
    public static let large = CGSize(width:360, height:120)
    public static let extraLarge = CGSize(width: UIScreen.screenWidth * 0.7, height: 210)
...
public class ChartData: ObservableObject, Identifiable {
    ...
    public func set (values:[(String, Int)]){
        self.points = values.map{($0.0, Double($0.1))}
        self.valuesGiven = true
        objectWillChange.send()
    }
    public func dailyReset()
    {
        if (points[6].0 != Day.today)
        {
            points[0] = (points[1].0, points[1].1)
            points[1] = (points[2].0, points[2].1)
            points[2] = (points[3].0, points[3].1)
            points[3] = (points[4].0, points[4].1)
            points[4] = (points[5].0, points[5].1)
            points[5] = (points[6].0, points[6].1)
            points[6] = (Day.today, 0)
        }
    }
    public func update(day: String, count: Double)
    {
        points[6] = (day, count)
        objectWillChange.send()
    }
